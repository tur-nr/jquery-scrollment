...
// @copyright  Copyright (c) 2012 Christopher Turner
// @link       https://github.com/tur-nr/jquery-scrollment
		...
		this.onScroll = function (event) {
			...
			for (var i = 0; i < this.stack.length; i++) {
				...
				if (! attachment.data.scrolling) {
					attachment.trigger('onStart', frame, frames);
					...
					if (frame == 0 || frame == frames) {
						attachment.trigger('onStop', frame, frames);
